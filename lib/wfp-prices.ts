...
const COMMODITY_MAP: { wfpName: string; commodity: string; unit: string; multiplier?: number }[] = [
  ...
  { wfpName: "Garlic (imported, China)", commodity: "Garlic (Imported)", unit: "kg" },
  { wfpName: "Onions (imported, India)", commodity: "Onion (Imported)", unit: "kg" },
  ...
  { wfpName: "Meat (beef)", commodity: "Beef", unit: "kg" },
  { wfpName: "Eggs (white)", commodity: "Egg (Farm)", unit: "dozen", multiplier: 12 },
