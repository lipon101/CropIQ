        ...
        <div className="flex-1 overflow-y-auto w-full space-y-2">
          ...
          {weather && !loading && (
            <>
              ...
              <button onClick={() => setShowForecast(!showForecast)} className="w-full bg-white rounded-xl border border-gray-200 px-4 py-2.5 flex items-center justify-between text-xs font-bold text-gray-700 hover:bg-gray-50 transition-colors">
