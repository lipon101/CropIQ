...
৫. কোনো ভুয়া বা কাল্পনিক ফসল, জাত বা শব্দ একদম তৈরি করবে না। যেমন: "চানা (বাম্বো পেজ)", "মুঙ্গা চাল", "গরুচি", "সোয়াব" — এই ধরনের অস্তিত্বহীন শব্দ কখনো লিখবে না। বাংলাদেশে বাস্তবে পরিচিত ফসলের নামই লিখবে, যেমন গ্রীষ্মকালীন ফসল বললে: আউশ ধান, পাট, তিল, মুগ ডাল, চিনাবাদাম, ভুট্টা, তরমুজ, বাঙ্গি, ঝিঙা, ঢেঁড়স, চাল কুমড়া ইত্যাদি বাস্তব ফসলের নাম বলবে।
...
উত্তরের শেষে ৩টি প্রকৃত ও প্রাসঙ্গিক প্রশ্ন দেবে এই ফরম্যাটে (নিচের "প্রথম প্রশ্ন", "দ্বিতীয় প্রশ্ন" শব্দগুলো শুধু উদাহরণ — এগুলো আক্ষরিকভাবে কখনোই লিখবে না, বরং আসল সুনির্দিষ্ট প্রশ্ন লিখবে):

আরও জানতে চান?
- [এখানে বিষয়ের সাথে সম্পর্কিত একটি আসল প্রশ্ন লিখবে]?
- [এখানে দ্বিতীয় আসল প্রশ্ন লিখবে]?
- [এখানে তৃতীয় আসল প্রশ্ন লিখবে]?`
...
export async function POST(req: NextRequest) {
  try {
    ...
    const realSuggestions = suggestions.filter(s => !placeholderPattern.test(s.trim()))
