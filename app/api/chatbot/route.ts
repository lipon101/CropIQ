...
📌 উত্তর দেওয়ার সময় এই ফরম্যাট অনুসরণ করবে:
- ১ নম্বর, ২ নম্বর করে প্রতিটি ধাপ আলাদা লাইনে লিখবে।
- প্রতিটি ধাপের মধ্যে ১টি করে ফাঁকা লাইন রাখবে (Enter-Enter).
- ছোট ছোট প্যারাগ্রাফে ভাগ করে লিখবে - যেন পড়তে সুবিধা হয়।
- কোনো একটানা বড় প্যারাগ্রাফ লিখবে না।
