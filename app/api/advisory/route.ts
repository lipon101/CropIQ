...
- irrigation: সেচ সংক্রান্ত ১টি অত্যন্ত সংক্ষিপ্ত একক লাইনের পরামর্শ (যেমন: বৃষ্টির কারণে আলাদা সেচের প্রয়োজন নেই।)
...
function generateFallbackAdvisory(district: string, crop: string, forecast: any[]) {
  ...
  if (weekRain > 40) {
    ...
    irrigation = "ভারী বৃষ্টির কারণে এ সপ্তাহে সেচের প্রয়োজন নেই।"
    ...
    irrigation = "সকালে বা বিকালে হালকা সেচ দিন, দুপুরে নয়।"
    ...
    irrigation = "স্বাভাবিক বৃষ্টির কারণে আলাদা সেচের প্রয়োজন নেই।"
    warning = ""
  } else {
    ...
    irrigation = "প্রয়োজন অনুযায়ী স্বাভাবিক নিয়মে সেচ দিন।"
    warning = ""
  }
